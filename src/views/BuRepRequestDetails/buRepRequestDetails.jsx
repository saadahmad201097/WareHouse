...
import { getBuRepRequestDetailsUrl, deleteBuRepRequestDetailsUrl } from '../../public/endpoins';
...
export default function BuRepRequest(props) {
    ...
    function getBuRepRequestDetails() {
        axios.get(getBuRepRequestDetailsUrl).then(res => {
            if(res.data.success) {
    ...
    function deleteBuRepRequestDetails() {
        ...
        axios.delete(deleteBuRepRequestDetailsUrl + '/' + params._id).then(res => {
            if (res.data.success) {
            setdeleteItem('');
        ...
        {buRepRequestDetails ? (
            ...
            <div>
                ...
                >
                    ...
                    <TableBody>
                    {buRepRequestDetails.map((data, index) => {
                        return (
                            <TableRow key={data._id} className={classes.tableBodyRow}>
                            <TableCell>
                                <span style={styles.tableData}>{data.buRepRequestId}</span>
                            </TableCell>
